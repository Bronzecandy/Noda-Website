            ...
            <div
                ...
                <div className="py-8 px-4 grid grid-cols-1 md:grid-cols-2 gap-8">
                    {stakingFeatures.map((feature, index) => (
                        <div key={index} className=" p-4 lg:p-8 bg-[#703519] bg-cover bg-no-repeat bg-top text-[#FBEDD0] shadow-md flex flex-col justify-between h-full gap-4 rounded-tl-2xl rounded-br-2xl ">
